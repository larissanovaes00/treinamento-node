    ...
    async getProductsByTermAmericanas(term) {
        try {
            ...
            $('div.StyledLayout__StyledPage-u6iyyw-2.hqaVnp').each((_, element) => {
                ...
                const priceHtml = $(element).find('src__Text-sc-154pg0p-0 src__PromotionalPrice-sc-1k0ejj6-7 iIPzUu').text()
                const product = {
                    title: $(element).find("src__Text-sc-154pg0p-0 src__Name-sc-1k0ejj6-3 dSRUrl").text(),
